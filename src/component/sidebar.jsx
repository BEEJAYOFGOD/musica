        ...
        <aside className="pt-8 flex flex-col gap-12 justify-center items-center ">
            <div className="flex flex-col gap-8 bg-[#191a1a] p-4 rounded-[32px]">
                <NavLink to={"/"} end>
                    {({ isActive }) => (
                        <svg
                            className={`home group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
                        ...
                        >
                            <path
                                ...
                                fill="#EFEEE015"
                                className={`transition-all duration-500 group-hover:fill-amber-400/90 ${
                                    isActive ? "fill-amber-300" : ""
                                }`}
                            />
                        </svg>
                    )}
                ...
                <NavLink to={"/playlist"} end>
                    {({ isActive }) => (
                        <svg
                            className={`playlist group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
                        ...
                        >
                            ...
                            />
                            <path
                                d="M12.7692 15.5192C12.4759 15.5192 12.2467 15.7575 12.2467 16.0417C12.2467 16.3258 12.485 16.3258 12.7692 16.5642C13.0534 16.5642 13.2917 16.3258 13.2917 16.0417C13.2917 15.7575 13.0534 15.5192 12.7692 15.5192Z"
                                fill="#EFEEE015"
                                className={`transition-all duration-500 group-hover:fill-amber-400/90 ${
                                    isActive ? "fill-amber-300" : ""
                                }`}
                ...
                <NavLink to={"/radio"} end>
                    {({ isActive }) => (
                        <svg
                            className={`radio group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
                ...
                <NavLink to={"/videos"} end>
                    {({ isActive }) => (
                        <svg
                            ...
                            viewBox="0 0 22 22"
                            fill="none"
                            className={`videos group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
            ...
            <div className="flex flex-col gap-4 bg-[#191a1a] items-center p-4 rounded-[32px]">
                <NavLink to={"/profile"} end>
                    {({ isActive }) => (
                        <svg
                            className={`profile w-8 h-8 group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
                ...
                <NavLink to={"/logout"} end>
                    {({ isActive }) => (
                        <svg
                            className={`logout w-8 h-8 group transition-all duration-500 hover:drop-shadow-2xl hover:drop-shadow-amber-400/90 hover:scale-110 ${
                                isActive
                                    ? "drop-shadow-amber-300 drop-shadow-2xl scale-105"
                                    : ""
                            }`}
