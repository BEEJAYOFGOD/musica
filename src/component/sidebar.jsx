            ...
            <div className=" flex flex-col gap-8 bg-[#191a1a] p-4 rounded-[32px]">
                ...
                >
                    <path
                        ...
                        fill="#EFEEE040"
                        className="group-hover:fill-amber-300  transition-all duration-300 group-hover:shadow-sm hover:drop-shadow-amber-300"
                    />
                </svg>

                <svg
                    className="playlist hover:drop-shadow-2xl hover:drop-shadow-amber-300 group"
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
                ...
                >
                    <path
                        ...
                        fill="#EFEEE040"
                        // fillOpacity="0.25"
                        className="playlist group-hover:drop-shadow-sm hover:drop-shadow-amber-300 group-hover:fill-amber-300"
                    />
                    <path
                ...
                <svg
                    className="radio hover:drop-shadow-2xl hover:drop-shadow-amber-300   group  transition-all duration-300"
                    xmlns="http://www.w3.org/2000/svg"
                    width="22"
                    height="22"
                    viewBox="0 0 22 22"
